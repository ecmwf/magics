...
m = MissingValue(0)
m.apply()
waveperiod_fieldset = FieldSet("swell_mwp.grib")
...
for area in arg_dict["area"]:
	...
	box = LegendBox(
		...
		legend_title_text = 'Mean period of total swell in seconds',
	...
	for step in arg_dict["step"]:
		...
		title = FieldAutoTitle(ice,text = [None,"Mean period of total swell and direction"])
		layout.plot(s(
				box,
