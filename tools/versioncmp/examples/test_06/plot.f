...
cc     CALL PSET1C ('OUTPUT_FORMATS',       FORMATS, 2)
       CALL PSETC  ('OUTPUT_NAME',         'wave_BANA')
...
c            fields (peak period and mean period) -
      ...
      read(11,1101,end=10) np,kpar
      read(11,1102,end=10) iy,im,id,ih
 ...
 1102 format(45x,4(1x,i2))
         ...
         NGY=ID2          
         do 241 j=1,ngy          
         READ(11,1103,end=10) (WAVEHT (I,J),I=1,NGX)
 1103 format(12f6.2)
 241     continue
         read(11,1101,end=10) np,kpar
         read(11,1102,end=10) iy,im,id,ih
         do 242 j=1,ngy    
         READ(11,1103,end=10) (WAVEDIR(I,J),I=1,NGX)
 242     continue
         read(11,1101,end=10) np, kpar
         read(11,1102,end=10) iy,im,id,ih
         do 243 j=1,ngy          
         read(11,1103,end=10) (a(i,j),i=1,ngx)
 243     continue
         read(11,1101,end=10) np,kpar
         read(11,1102,end=10) iy,im,id,ih
         do 244 j=1,ngy         
         read(11,1103,end=10) (b(i,j),i=1,ngx)
 244     continue
