...
low_input = minput(input_x_type='date',
                input_date_x_values = dates,
				input_date_x2_values = dates,
				input_y_values = lows,
...
medium_input = minput(input_x_type='date',
                input_date_x_values = dates,
				input_date_x2_values = dates,
...
high_input = minput(input_x_type='date',
                input_date_x_values = dates,
				input_date_x2_values = dates,
...
extreme_input = minput(input_x_type='date',
                input_date_x_values = dates,
				input_date_x2_values = dates,
				input_y_values = extremes,
				input_y2_values = [max, max],
                )    
                           
extreme_graph =  mgraph(
...
extremes_input = minput(input_x_type='date',
  input_date_x_values = data['FOR_PROBABILISTIC']['DATE'],
  input_y2_values = data['FOR_PROBABILISTIC']['QMIN'],
  input_date_x2_values = data['FOR_PROBABILISTIC']['DATE'],
  input_y_values = data['FOR_PROBABILISTIC']['QMAX'],
)

extremes_graph = mgraph(graph_type = "area",
  graph_line_colour='rgb(0.7,0.87,0.9)',
  graph_shade_colour = "rgba(0.7,0.87,0.9,0.6)"
)
q75_25_input = minput(input_x_type='date',
  input_date_x_values = data['FOR_PROBABILISTIC']['DATE'],
  input_y2_values = data['FOR_PROBABILISTIC']['Q75'],
  input_date_x2_values = data['FOR_PROBABILISTIC']['DATE'],
  input_y_values = data['FOR_PROBABILISTIC']['Q25'],
)
q75_25_graph = mgraph(graph_type = "area",
  graph_line_colour='rgb(0.60,0.85,0.9)',
  graph_shade_colour = "rgba(0.60,0.85,0.9,0.8)"
)
median_input = minput(input_x_type='date',
  input_date_x_values = data['FOR_PROBABILISTIC']['DATE'],
  input_y_values = data['FOR_PROBABILISTIC']['QMED'],
)
median_graph =mgraph(
...
plot(output, projection, vertical, horizontal, 
        ...
        medium_input,medium_graph,
         ...
         extreme_input, extreme_graph,
       	...
       	extremes_input, extremes_graph,
		q75_25_input, q75_25_graph,
		median_input, median_graph,
		eud_input, eud_graph,
		dwd_input, dwd_graph,
