...
void ThinningMethod::operator()(Data &, const Transformation &,
...
void AutomaticThinningMethod::set(const ThinningMethodUI &ui) {
  ...
  units_ = nbPoints_;
  rawOnly_ = ui.rawOnly_; // If true, do not thin .. only show raw data if
...
static SimpleObjectMaker<AutomaticThinningMethod, ThinningMethod>
    automatic("automatic");
static SimpleObjectMaker<BasicThinningMethod, BasicThinningMethod>
    basic("basic");
