...
Coastlines::Coastlines() { setInfo("_datatype", "Coastlines"); }
...
void Coastlines::visit(LegendVisitor &legend) { coastlines_->visit(legend); }
...
void Coastlines::visit(PreviewVisitor &preview) { (*coastlines_)(preview); }
