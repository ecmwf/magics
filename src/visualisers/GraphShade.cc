...
void GraphShade::operator()(Polyline &box) { (*style_)(box); }
...
void GraphShade::operator()(CustomisedPointsList &points,
                            vector<UserPoint> &out) {
...
void NoGraphShade::operator()(CustomisedPointsList &points,
                              vector<UserPoint> &out) {
  for (auto &point : points) {
