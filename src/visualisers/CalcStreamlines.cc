                        ...
                        if (act_side == 1) {
                            ...
                            if (act_dir == 0) {
                                ...
                                if (new_y <= cell_y + dy_2e && new_y >= cell_y - dy_2e) {
                                    ...
                                    if (act_dir > M3_PI_2) {
                                        // Northward
                                        x[pos] = ShiftPeriod(x[pos - direction] + (cell_y + dy_2 - y[pos - direction]) *
                                                                                      tan_dir / cos_cell_y,
                                                             x_min, x_per);
                                        y[pos] = cell_y + dy_2;
                                        ...
                                        // Southward
                                        x[pos] = ShiftPeriod(x[pos - direction] - (y[pos - direction] - cell_y + dy_2) *
                                                                                      tan_dir / cos_cell_y,
                                                             x_min, x_per);
                                        y[pos] = cell_y - dy_2;
                            ...
                            if (act_dir < M__PI_2 || act_dir > M3_PI_2) {
                                // Compare the neighbouring wind directions
                                if (cycle_cont &&
                                    (prev_dir > 0 && prev_dir < M__PI) == (act_dir > 0 && act_dir < M__PI))
                                ...
                                if (new_x <= cell_x + dx_2e && new_x >= cell_x - dx_2e) {
                                    ...
                                    if (act_dir < M__PI) {
                                        ...
                                        if (gs_geo)
                                            y[pos] =
                                                y[pos - direction] +
                                                CalcLonDist(cell_x + dx_2, x[pos - direction]) / tan_dir * cos_cell_y;
                                        else
                                            y[pos] = y[pos - direction] +
                                                     fabs(cell_x + dx_2 - x[pos - direction]) / tan_dir * cos_cell_y;
                                        ...
                                        if (gs_geo)
                                            y[pos] =
                                                y[pos - direction] -
                                                CalcLonDist(x[pos - direction], cell_x - dx_2) / tan_dir * cos_cell_y;
                                        else
                                            y[pos] = y[pos - direction] -
                                                     fabs(x[pos - direction] - cell_x + dx_2) / tan_dir * cos_cell_y;
