...
class CompatibilityHelper {
 public:
  ...
  static bool check(const string& param, P value) {
    map<string, CompatibilityHelper*>::const_iterator tool =
        compatibility_.find(lowerCase(param));
  ...
  static void reset(const string& param) {
    map<string, CompatibilityHelper*>::const_iterator tool =
        compatibility_.find(lowerCase(param));
    if (tool != compatibility_.end()) (*(tool->second)).reset();
  }
...
class NoMoreGribex : public CompatibilityHelper {
 public:
  NoMoreGribex(const string& param)
      : CompatibilityHelper(param), parameter_(param) {}
  ~NoMoreGribex() {}
  bool operator()(const string&) {
    MagLog::info()
        << "Compatibility issue: the parameter [" << parameter_
        << "] is discontinued.\n"
        << "              Please use the grib_api interface  instead."
        << std::endl;
    return true;
  }
...
class IgnoreConverter : public CompatibilityHelper {
 public:
  IgnoreConverter(const string& param)
      : CompatibilityHelper(param), parameter_(param) {}
  ~IgnoreConverter() {}
  bool operator()(const string&) {
    MagLog::info() << "Deprecated: Parameter " << parameter_
                   << " is not needed anymore --> setting is ignored"
                   << std::endl;
    return true;
  }
...
class ComingSoonConverter : public CompatibilityHelper {
 public:
  ComingSoonConverter(const string& param)
      : CompatibilityHelper(param), parameter_(param) {}
  ~ComingSoonConverter() {}
  bool operator()(const string&) {
    MagLog::info() << "Coming soon: Parameter " << parameter_
                   << " will be implemented soon" << std::endl;
    return true;
  }
...
class SimpleTranslator : public CompatibilityHelper {
 public:
  ...
  ~SimpleTranslator() {}
  void deprecated() {
    MagLog::warning() << "Compatibility issue: Parameter " << from_
                      << " is deprecated : consider using " << to_
                      << " instead\n";
  }
...
class ActionInterceptor : public CompatibilityHelper {
 public:
  ActionInterceptor(const string& from, FortranMagics::Action action)
      : CompatibilityHelper(from), action_(action) {}
  ~ActionInterceptor() {}
 ...
 public:
  ...
  bool operator()(const string& res) {
    if (magCompare(res, "high") || magCompare(res, "medium")) {
      MagLog::info() << "Magics is using the \'" << res
                     << "\' dataset for coastlines from Natural Earth.\n"
 ...
 public:
  ...
  bool operator()(const string& file) {
    MagLog::info() << "Compatibility issue: ps_file_name is deprecated.\n"
                   << "               Please use output_name instead."
                   << std::endl;
...
class OutputPsDevice : public CompatibilityHelper {
 public:
  ...
  ~OutputPsDevice() {}
  bool operator()(const string&) {
    MagLog::info() << "Compatibility issue: output_ps_device is deprecated."
                   << std::endl;
    return true;
  }
};
...
class OutputResolution : public CompatibilityHelper {
 public:
  ...
  bool operator()(int) {
    MagLog::info()
        << "Deprecated parameter: output_resolution is not used anymore.\n"
...
class GraphValuesConverter : public CompatibilityHelper {
 public:
  ...
  bool operator()(const doublearray& values) {
    MagLog::info() << "Compatibility issue: Parameter " << from_
                   << " is deprecated.\n"
                   << "               Please use " << to_ << " instead."
                   << std::endl;
...
static GraphValuesConverter graph_curve_x_values("graph_curve_x_values",
                                                 "x_values");
static GraphValuesConverter graph_curve_y_values("graph_curve_y_values",
                                                 "y_values");
static GraphValuesConverter graph_curve_date_x_values(
    "graph_curve_date_x_values", "x_date_values");
static GraphValuesConverter graph_curve_date_y_values(
    "graph_curve_date_y_values", "y_date_values");

static GraphValuesConverter graph_curve_x_base_date("graph_curve_x_base_date",
                                                    "x_base_date");
static GraphValuesConverter graph_curve_x_date_offset(
    "graph_curve_x_date_offset", "x_date_offset");
static GraphValuesConverter graph_curve_y_base_date("graph_curve_y_base_date",
                                                    "y_base_date");
static GraphValuesConverter graph_curve_y_date_offset(
    "graph_curve_y_date_offset", "y_date_offset");

static GraphValuesConverter graph_curve_x2_base_date("graph_curve_x2_base_date",
                                                     "x2_base_date");
static GraphValuesConverter graph_curve_x2_date_offset(
    "graph_curve_x2_date_offset", "x2_date_offset");
static GraphValuesConverter graph_curve_y2_base_date("graph_curve_y2_base_date",
                                                     "y2_base_date");
static GraphValuesConverter graph_curve_y2_date_offset(
    "graph_curve_y2_date_offset", "y2_date_offset");

static GraphValuesConverter graph_curve2_x_values("graph_curve2_x_values",
                                                  "x2_values");
static GraphValuesConverter graph_curve2_y_values("graph_curve2_y_values",
                                                  "y2_values");
static GraphValuesConverter graph_curve2_date_x_values(
    "graph_curve2_date_x_values", "x2_date_values");
static GraphValuesConverter graph_curve2_date_y_values(
    "graph_curve2_date_y_values", "y2_date_values");

static ValuesConverter symbol_input_text_list("symbol_input_text_list",
                                              "symbol_texts");
static ValuesConverter contour_hilo_text_blanking("contour_hilo_text_blanking",
                                                  "contour_hilo_blanking");
static GraphValuesConverter graph_bar_x_values("graph_bar_x_values",
                                               "x_values");
static GraphValuesConverter graph_bar_y_values("graph_bar_y_values",
                                               "y_values");
static GraphValuesConverter graph_bar_date_x_values("graph_bar_date_x_values",
                                                    "x_date_values");
static GraphValuesConverter graph_bar_date_y_values("graph_bar_date_y_values",
                                                    "y_date_values");

static GraphValuesConverter graph_bar_x_lower_values("graph_bar_x_lower_values",
                                                     "x_lower_values");
static GraphValuesConverter graph_bar_x_upper_values("graph_bar_x_upper_values",
                                                     "x_upper_values");
static GraphValuesConverter graph_bar_date_x_lower_values(
    "graph_bar_date_x_lower_values", "x_lower_date_values");
static GraphValuesConverter graph_bar_date_x_upper_values(
    "graph_bar_date_x_upper_values", "x_upper_date_values");

static GraphValuesConverter graph_bar_y_lower_values("graph_bar_y_lower_values",
                                                     "y_lower_values");
static GraphValuesConverter graph_bar_y_upper_values("graph_bar_y_upper_values",
                                                     "y_upper_values");
static GraphValuesConverter graph_bar_date_y_lower_values(
    "graph_bar_date_y_lower_values", "y_lower_date_values");
static GraphValuesConverter graph_bar_date_y_upper_values(
    "graph_bar_date_y_upper_values", "y_upper_date_values");
...
class DeviceFileName : public CompatibilityHelper {
 public:
  ...
  bool operator()(const string& file) {
    MagLog::info()
        << "Compatibility issue: Parameter device_file_name is deprecated.\n"
...
class DeviceWidth : public CompatibilityHelper {
 public:
  ...
  bool operator()(const int width) {
    MagLog::info()
        << "Compatibility issue: Parameter device_width is deprecated.\n"
 ...
 public:
  ...
  bool operator()(const int quality) {
    MagLog::info() << "Compatibility issue: Parameter device_quality_level is "
                      "deprecated.\n"
                   << "             Please use output_jpg_quality instead."
                   << std::endl;
...
class TextQuality : public CompatibilityHelper {
 public:
  ...
  bool operator()(const string& quality) {
    MagLog::info() << "Compatibility issue: Parameter " << base_
                   << "quality is deprecated.\n"
                   << "               Please use " << base_ << "font and "
                   << base_ << "font_style instead." << std::endl;
    ...
    if (magCompare(quality, "low")) {
      ...
      MagLog::warning() << "The setting " << quality << " for the parameter "
                        << base_
                        << "_quality is not valid! Default font is used."
                        << std::endl;
      ParameterManager::set(base_ + "font", "sansserif");
      ParameterManager::set(base_ + "font_style", "normal");
    }
...
class TextHeight : public CompatibilityHelper {
 public:
  TextHeight(const string& from, const string& to)
      : CompatibilityHelper(from), from_(from), to_(to) {}
  ~TextHeight() {}
  bool operator()(double height) {
    MagLog::warning() << "Compatibility issue: Parameter " << from_
                      << " is deprecated.\n"
                      << "               Please use " << to_ << " instead. "
                      << to_ << " has been set to " << height << std::endl;
...
class TextFontHeight : public CompatibilityHelper {
 public:
  TextFontHeight(const string& from, const string& to)
      : CompatibilityHelper(from), from_(from), to_(to) {}
  ~TextFontHeight() {}
  bool operator()(double height) {
    if (from_ != to_) {
...
class GdFileName : public CompatibilityHelper {
 public:
  ...
  bool operator()(const string& file) {
    MagLog::info()
        << "Compatibility issue: Parameter gd_file_name is deprecated.\n"
        << "              Please use output_name instead." << std::endl;
    ParameterManager::set("output_legacy_name", file);
    ParameterManager::set("output_file_minimal_width", 0);
    return true;
...
class DeviceCompatibilityHelper : public CompatibilityHelper {
 public:
  ...
  bool operator()(const string& device) {
    MagLog::info()
        << "Compatibility issue: the parameter device is deprecated.\n"
        << "              Please use the parameter output_format instead!"
        << endl;

    if (magCompare(device, "jpeg") || magCompare(device, "jpg") ||
        magCompare(device, "png") || magCompare(device, "gif")) {
...
class ContourAutomaticSetting : public CompatibilityHelper {
 public:
  ContourAutomaticSetting()
      : CompatibilityHelper("contour_automatic_setting") {}
  ~ContourAutomaticSetting() {}
 ...
 public:
  ...
  bool operator()(int index) {
    ...
    if (ratio == 1)
      ...
      MagLog::warning() << "invalid ratio " << ratio << " revert to default 1."
                        << endl;
      head_ratio = 1.;
    }
...
static TextFontHeight text_reference_character_height(
    "text_reference_character_height", "text_font_size");
static TextFontHeight text_height("text_font_size", "text_font_size");
static TextFontHeight legend_text_font_size("legend_text_font_size",
...
static SimpleTranslator contour_predefined_setting("contour_predefined_setting",
                                                   "contour_style_name");
static SimpleTranslator netcdf_x_position_variable("netcdf_x_position_variable",
                                                   "netcdf_x_variable");
static SimpleTranslator netcdf_y_position_variable("netcdf_y_position_variable",
                                                   "netcdf_y_variable");
static SimpleTranslator legend_text_height("legend_text_height",
                                           "legend_text_font_size");
static SimpleTranslator graph_shade_colour("graph_shade_colour",
                                           "graph_bar_colour", true);
static SimpleTranslator graph_bar_colour("graph_bar_colour",
                                         "graph_shade_colour", true);
static SimpleTranslator subpage_map_area_definition(
    "subpage_map_area_definition", "subpage_map_area_definition_polar", true);
...
static SimpleTranslator odb_longitude("odb_longitude",
                                      "odb_longitude_variable");
static SimpleTranslator odb_y_component("odb_y_component",
                                        "odb_y_component_variable");
static SimpleTranslator odb_x_component("odb_x_component",
...
static SimpleTranslator netcdf_value_variable("netcdf_field_variable_name",
                                              "netcdf_value_variable");
static SimpleTranslator netcdf_latitude_variable(
    "netcdf_latitude_variable_name", "netcdf_latitude_variable");
static SimpleTranslator netcdf_longitude_variable(
    "netcdf_longitude_variable_name", "netcdf_longitude_variable");
static SimpleTranslator netcdf_x_component_variable(
    "netcdf_x_component_variable_name", "netcdf_x_component_variable");
static SimpleTranslator netcdf_y_component_variable(
    "netcdf_y_component_variable_name", "netcdf_y_component_variable");
static SimpleTranslator netcdf_x_variable("netcdf_x_variable_name",
                                          "netcdf_x_variable");
static SimpleTranslator netcdf_y_variable("netcdf_y_variable_name",
                                          "netcdf_y_variable");
static SimpleTranslator netcdf_x_position_variable_name(
    "netcdf_x_position_variable_name", "netcdf_x_variable");
static SimpleTranslator netcdf_y_position_variable_name(
    "netcdf_y_position_variable_name", "netcdf_y_variable");
static SimpleTranslator netcdf_x2_variable_name("netcdf_x2_variable_name",
                                                "netcdf_x_auxiliary_variable");
static SimpleTranslator graph_x_missing_value("graph_x_missing_value",
                                              "x_missing_value");
static SimpleTranslator graph_y_missing_value("graph_y_missing_value",
                                              "y_missing_value");
static SimpleTranslator symbol_marker("symbol_marker", "symbol_marker_index");

// Clean font parametermap_cities_font_
static SimpleTranslator map_cities_font_name("map_cities_font_name",
                                             "map_cities_font");
static SimpleTranslator eps_maximum_font_name("eps_maximum_font_name",
                                              "eps_maximum_font");
static SimpleTranslator magnifier_text_font_name("magnifier_text_font_name",
                                                 "magnifier_text_font");
static SimpleTranslator symbol_text_font_name("symbol_text_font_name",
                                              "symbol_text_font");
...
MAGICS_EXPORT void popen_() {
  if (magics_ == 0) magics_ = new FortranMagics();
  magics_->popen();
}

MAGICS_EXPORT void pcoast_() { magics_->pcoast(); }

MAGICS_EXPORT void ptaylor_() { magics_->ptaylor(); }

MAGICS_EXPORT void ptephi_() { magics_->ptephi(); }

MAGICS_EXPORT void pgrib_() { magics_->pgrib(); }

MAGICS_EXPORT const char* metagrib_() { return magics_->metagrib(); }
...
MAGICS_EXPORT const char* metanetcdf_() { return magics_->metanetcdf(); }

MAGICS_EXPORT const char* metainput_() { return magics_->metainput(); }

MAGICS_EXPORT void pmapgen_() { magics_->pmapgen(); }

MAGICS_EXPORT void ptest_() { magics_->ptest(); }
...
MAGICS_EXPORT void pimport_() { magics_->pimport(); }

MAGICS_EXPORT void poverlay_() { magics_->poverlay(); }

MAGICS_EXPORT void pnetcdf_() { magics_->pnetcdf(); }

MAGICS_EXPORT void pcont_() { magics_->pcont(); }

MAGICS_EXPORT void pobs_() { magics_->pobs(); }
...
MAGICS_EXPORT void pimage_() { magics_->pimage(); }
...
MAGICS_EXPORT void ptext_() { magics_->ptext(); }

MAGICS_EXPORT void pwind_() { magics_->pwind(); }

MAGICS_EXPORT void pline_() { magics_->pline(); }

MAGICS_EXPORT void psymb_() { magics_->psymb(); }
...
MAGICS_EXPORT void presets_() { ParameterManager::reset(); }
...
MAGICS_EXPORT void psetc_(const char* name, const char* value, int namel,
                          int valuel) {
  try {
...
MAGICS_EXPORT void pset1i_(const char* name, const int* data, const int* dim,
                           int length) {
  std::string n(name, length);
  try {
    ...
    for (int i = 0; i < s; i++) fvalue[i] = data[i];
    mag_set1r(name, fvalue, *dim);
    delete[] fvalue;
  }
}

MAGICS_EXPORT void pset2i_(const char* name, const int* data, const int* dim1,
                           const int* dim2, int length) {
  std::string n(name, length);
  try {
    ...
    for (int i = 0; i < dim; i++) fvalue[i] = data[i];
    mag_set2r(name, fvalue, *dim1, *dim2);
    delete[] fvalue;
  }
}

MAGICS_EXPORT void pset3i_(const char* name, const int* data, const int* dim,
                           const int* dim2, const int* dim3, int length) {
  std::string n(name, length);
  mag_set3i(n.c_str(), data, *dim, *dim2, *dim3);
}

MAGICS_EXPORT void pset1c_(const char* name, const char* value, const int* dim,
                           int namel, int l) {
  stringarray values;
...
MAGICS_EXPORT void penqc_(const char* name, char* value, int length,
                          int vlength) {
  std::string n(name, length);
  mag_enqc(n.c_str(), value);

  for (int i = strlen(value); i < vlength; i++) value[i] = ' ';
}

MAGICS_EXPORT const char* detect_(const char* data, char* dimension, int l1,
                                  int l2) {
...
MAGICS_EXPORT void pgraph_() { magics_->pgraph(); }

MAGICS_EXPORT void paxis_() { magics_->paxis(); }

MAGICS_EXPORT void pgeo_() { magics_->pgeo(); }

MAGICS_EXPORT void pinput_() { magics_->pinput(); }

MAGICS_EXPORT void ptable_() { magics_->ptable(); }

MAGICS_EXPORT void peps_() {
  MagLog::warning() << "peps-->not yet implemented\n";
}

MAGICS_EXPORT void pboxplot_() { magics_->pboxplot(); }

MAGICS_EXPORT void ptile_() { magics_->ptile(); }

MAGICS_EXPORT void pwrepjson_() { magics_->wrepjson(); }

MAGICS_EXPORT void pgeojson_() { magics_->geojson(); }

MAGICS_EXPORT void pepsinput_() { magics_->epsinput(); }

MAGICS_EXPORT void pmetgraph_() { magics_->metgraph(); }

MAGICS_EXPORT void pmetbufr_() { magics_->metbufr(); }

MAGICS_EXPORT void pepscloud_() { magics_->epscloud(); }

MAGICS_EXPORT void pepsplumes_() { magics_->epsplumes(); }

MAGICS_EXPORT void pepsgraph_() { magics_->epsgraph(); }

MAGICS_EXPORT void pepslight_() { magics_->epslight(); }

MAGICS_EXPORT void pepswave_() { magics_->epswave(); }

MAGICS_EXPORT void pepswind_() { magics_->epswind(); }

MAGICS_EXPORT void pepsbar_() { magics_->epsbar(); }

MAGICS_EXPORT void pepsshading_() { magics_->epsshading(); }
...
MAGICS_EXPORT void mag_mute() { MagicsGlobal::silent(true); }
PYTHON(py_mute, mag_mute)

MAGICS_EXPORT void mag_unmute() { MagicsGlobal::silent(false); }
...
MAGICS_EXPORT void mag_tile() { ptile_(); }
...
MAGICS_EXPORT void mag_new(const char* page) { magics_->pnew(page); }
...
MAGICS_EXPORT const char* py_set1r(const char* name, const double* data,
                                   const int dim1) {
  try {
...
MAGICS_EXPORT const char* py_set2r(const char* name, const double* data,
...
MAGICS_EXPORT void mag_set3r(const char*, const double*, const int, const int,
                             const int) {
  MagLog::warning() << "pset3r --> not yet implemented\n";
}

MAGICS_EXPORT const char* py_set1i(const char* name, const int* data,
                                   const int dim1) {
  try {
...
MAGICS_EXPORT void mag_set1i(const char* name, const int* data,
                             const int dim1) {
...
MAGICS_EXPORT const char* py_set2i(const char* name, const int* data,
                                   const int dim1, const int dim2) {
  try {
...
MAGICS_EXPORT void mag_set3i(const char*, const int*, const int, const int,
                             const int) {
  MagLog::warning() << "pset3i --> not yet implemented\n";
}

MAGICS_EXPORT const char* py_set1c(const char* name, const char** data,
                                   const int dim1) {
  try {
...
MAGICS_EXPORT void mag_set1c(const char* name, const char** data,
                             const int dim) {
  string param(name);
  ...
  for (int i = 0; i < dim; i++) {
    ...
    string val = (index1 == string::npos || index2 == string::npos)
                     ? ""
                     : work.substr(index1, index2 + 1);
...
MAGICS_EXPORT void mag_enqr(const char* fname, double* value) {
  ...
  for (vector<string>::iterator param = special.begin(); param != special.end();
       ++param) {
...
MAGICS_EXPORT void mag_clear_listeners() { MagLog::clearListeners(); }
...
MAGICS_EXPORT void mag_info() {
  MagLog::userInfo()
      ...
      << "INFO:\n"
      << "INFO: Machine: " << getEnvVariable("HOSTNAME") << " is running "
      << getEnvVariable("VENDOR") << " " << getEnvVariable("OSTYPE") << " "
      << getEnvVariable("MACHTYPE") << "\n"
      << "INFO:\n"
 ...
 public:
  ...
  void update(const string& val) {
    ...
    if (magCompare(val, "position_list")) {
      MagLog::info()
          << "position_list is now using the user coordinates system and not cm"
          << endl;
      return;
    }
...
static AxisConverter axis_type("axis_type", "subpage_x_axis_type",
                               "subpage_y_axis_type");

static AxisConverter axis_min_value("axis_min_value", "subpage_x_min",
                                    "subpage_y_min");
static AxisConverter axis_max_value("axis_max_value", "subpage_x_max",
                                    "subpage_y_max");
...
static AxisConverter axis_max_date_value("axis_date_max_value",
                                         "subpage_x_date_max",
                                         "subpage_y_date_max");
static AxisConverter graph_axis_control("graph_axis_control",
                                        "subpage_x_automatic",
                                        "subpage_y_automatic");

void execute_magml(const char* file) { WebInterpretor::magml(file); }

void execute_json(const char* file) { WebInterpretor::json(file); }

void set_param(const char* param, const char* value) {
  WebInterpretor::set(param, value);
}

static ActionInterceptor symbol_input_x_position(
    "symbol_input_x_position", &FortranMagics::flagInputSymbol);
static ActionInterceptor symbol_input_y_position(
    "symbol_input_y_position", &FortranMagics::flagInputSymbol);
static ActionInterceptor symbol_input_wind_direction(
    "symbol_input_wind_direction", &FortranMagics::flagInputSymbol);
static ActionInterceptor symbol_input_wind_speed(
    "symbol_input_wind_speed", &FortranMagics::flagInputSymbol);

static ActionInterceptor input_field("input_field",
                                     &FortranMagics::flagInputMatrix);
static ActionInterceptor input_simple_field("input_simple_field",
                                            &FortranMagics::flagInputMatrix);
static ActionInterceptor input_wind_u_component(
    "input_wind_u_component", &FortranMagics::flagInputMatrix);
static ActionInterceptor input_wind_v_component(
    "input_wind_v_component", &FortranMagics::flagInputMatrix);
static ActionInterceptor input_wind_speed("input_wind_speed",
                                          &FortranMagics::flagInputMatrix);
static ActionInterceptor input_wind_direction("input_wind_direction",
                                              &FortranMagics::flagInputMatrix);

static ActionInterceptor polyline_input_latitudes(
    "polyline_input_latitudes", &FortranMagics::flagInputPoly);
static ActionInterceptor polyline_input_longitudes(
    "polyline_input_longitudes", &FortranMagics::flagInputPoly);
static ActionInterceptor polyline_input_positions_filename(
    "polyline_input_positions_filename", &FortranMagics::flagInputPoly);
 ...
 public:
  ...
  bool operator()(const string& val) {
    if (magCompare(val, "user")) {
      MagLog::warning()
          << "The value user for page_id_line_logo_plot is now deprecated.\n"
