...
InteractiveSet::InteractiveSet(Layer *layer, const string &box)
    : BasicGraphicsObject(layer, box) {
  begin_ = new InteractiveBegin();

  end_ = new InteractiveEnd();
}

bool InteractiveSet::reproject(const Transformation &transformation,
                               GraphicsList &out) const {
...
InteractiveBegin::InteractiveBegin(Layer *layer, const string &box)
    : BasicGraphicsObject(layer, box) {}
...
bool InteractiveBegin::reproject(const Transformation &transformation,
                                 GraphicsList &out) const {
  return true;
}

InteractiveEnd::InteractiveEnd(Layer *layer, const string &box)
    : BasicGraphicsObject(layer, box) {}
...
bool InteractiveEnd::reproject(const Transformation &transformation,
                               GraphicsList &out) const {
  return true;
}

void InteractiveEnd::print(ostream &out) const { out << "InteractiveEnd[]"; }
