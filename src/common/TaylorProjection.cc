...
bool TaylorProjection::needShiftedCoastlines() const { return false; }

void TaylorProjection::aspectRatio(double &width, double &height) {
  Transformation::aspectRatio(width, height);
}

void TaylorProjection::boundingBox(double &xmin, double &ymin, double &xmax,
                                   double &ymax) const {
  Transformation::boundingBox(xmin, ymin, xmax, ymax);
}

double TaylorProjection::getMinX() const { return min_; }

double TaylorProjection::getMinY() const { return 0; }

double TaylorProjection::getMaxX() const { return max_; }
...
void TaylorProjection::setMinX(double x) { min_ = x; }

void TaylorProjection::setMinY(double y) { min_ = y; }

void TaylorProjection::setMaxX(double x) { max_ = x; }

void TaylorProjection::setMaxY(double y) { max_ = y; }

double TaylorProjection::getMinPCX() const { return min_; }

double TaylorProjection::getMinPCY() const { return min_; }

double TaylorProjection::getMaxPCX() const { return max_; }

double TaylorProjection::getMaxPCY() const { return max_; }
...
void TaylorProjection::setDefinition(const string &def) { ASSERT(def.empty()); }
