...
template <class T>
void TableDefinitionList<T>::set(
    const TableDefinitionListInterface<T> &attributes) {
...
template <class T> void TableDefinitionList<T>::set(const XmlNode &node) {
  MagLog::info()
      << "TableDefinitionList::set(const XmlNode&): to be implemented\n";
