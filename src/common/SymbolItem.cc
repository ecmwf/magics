...
void FlagItem::redisplay(const ComplexSymbol &symbol,
                         const BaseDriver &driver) {
  driver.redisplay(*this, symbol);
}

void SymbolItem::redisplay(const ComplexSymbol &symbol,
                           const BaseDriver &driver) {
  driver.redisplay(*this, symbol);
}
void TextItem::redisplay(const ComplexSymbol &symbol,
                         const BaseDriver &driver) {
  driver.redisplay(*this, symbol);
}
