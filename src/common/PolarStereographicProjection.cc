...
PaperPoint PolarStereographicProjection::
operator()(const UserPoint &point) const {
  ASSERT(projection_);
...
PaperPoint PolarStereographicProjection::
operator()(const PaperPoint &point) const {
...
MatrixHandler *
PolarStereographicProjection::prepareData(const AbstractMatrix &matrix) const {
