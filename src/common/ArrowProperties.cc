...
ArrowProperties::ArrowProperties()
    : scale_(0), crossBoundary_(false), thickness_(1), style_(M_SOLID),
      hemisphere_(NORTH), position_(M_TAIL), originMarker_("none"),
      originHeight_(0), headIndex_(0), headRatio_(0.3) {}
