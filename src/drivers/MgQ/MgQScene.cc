...
MgQScene::MgQScene(MgQRootItem *plotRootItem, QObject *parent)
    : QGraphicsScene(parent), plotRootItem_(plotRootItem) {
  addItem(plotRootItem_);
...
void MgQScene::renderContents(QPainter *painter, const QRectF &targetRect,
                              const QRectF &sourceRect) {
  QStyleOptionGraphicsItem option;
  renderContents(painter, &option, targetRect, sourceRect);
}

void MgQScene::renderItemRecursively(QGraphicsItem *item, QPainter *painter,
                                     const QStyleOptionGraphicsItem *option) {
