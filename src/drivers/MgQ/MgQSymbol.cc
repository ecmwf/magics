...
void MgQSymbolSetItem::setConnectLinePen(QPen pen) { connectLinePen_ = pen; }
...
void MgQSymbolSetItem::paint(QPainter *painter,
                             const QStyleOptionGraphicsItem *, QWidget *) {
  // qDebug() << "Symbol" << painter->clipRegion() << painter->clipPath() <<
  // painter->transform();
...
MgQSymbolItem *MgQSymbolManager::getSymbol(const QString &id,
                                           const float size) {
...
MgQSymbolItem *MgQSymbolManager::addSymbol(const QString &id,
                                           const float size) {
