...
MgQPathItem::MgQPathItem(const QPainterPath& path, QGraphicsItem* parent) : QGraphicsPathItem(path, parent) {}
...
void MgQPathItem::paint(QPainter* painter, const QStyleOptionGraphicsItem* option, QWidget* widget) {
