...
const char *ellipsoidList[] = {
    "Airy",         "6.3775634e+06", "3.340906e-03",  "Clarke-1866",
    "6.378206e+06", "3.390060e-03",  "EarthRadius",   "6.371000e+06",
    "0.000000e+00", "Everest",       "6.3772763e+06", "3.324468e-03",
    "GRS80",        "6.378137e+06",  "3.352811e-03",  "Hayford",
    "6.378388e+06", "3.367003e-03",  "UGGI67",        "6.378160e+06",
    "3.352892e-03", "WGS84",         "6.378137e+06",  "3.352811e-03"};

// DatumName    Spheroid        Shift_X           Shift_Y           Shift_Z

const char *datumList[] = {
    "Astro-Chua",   "Hayford",       "-7.700000e+01", "2.390000e+02",
    "5.000000e+00", "CorregoAlegre", "Hayford",       "-1.387000e+02",
    "1.644000e+02", "3.440000e+01",  "Indian",        "Everest",
    "0.000000e+00", "0.000000e+00",  "0.000000e+00",  "NAD27",
    "Clarke-1866",  "0.000000e+00",  "0.000000e+00",  "0.000000e+00",
    "NAD83",        "GRS80",         "0.000000e+00",  "0.000000e+00",
    "0.000000e+00", "SAD69",         "UGGI67",        "0.000000e+00",
    "0.000000e+00", "0.000000e+00",  "Spherical",     "EarthRadius",
    "0.000000e+00", "0.000000e+00",  "0.000000e+00",  "WGS84",
    "WGS84",        "6.687000e+01",  "-4.370000e+00", "3.852000e+01",
    "Aratu",        "Hayford",       "-7.81300e+01",  "2.9163000e+02",
    "-1.08480e+02"};

const char **TeGetDatumList() { return datumList; }
...
string TeDatum::getProj4Description() {
  ...
  if (shiftX != 0.0 && shiftY != 0.0 && shiftZ != 0.0)
    datumProj4 += " +towgs84=" + Te2String(shiftX, 4) + "," +
                  Te2String(shiftY, 4) + "," + Te2String(shiftZ, 4);
  return datumProj4;
}
...
string TeDatum::getWKTDescription() {
  ...
  string crs_epsgcode = "";
  string datumWKT =
      "GEOGCS[\"" + name_ + "\"," + "DATUM[\"" + name_ + "\", SPHEROID[\"";
  if (name_ == "Astro-Chua") {
    spheroid = "Hayford";
    sph_epsgcode = "7022";
    dtm_epsgcode = "6224";
  ...
  datumWKT +=
      spheroid + "\"," + Te2String(rd_, 6) + ", " + Te2String(1.0 / flt_, 6);
  ...
  if (shiftX != 0.0 && shiftY != 0.0 && shiftZ != 0.0)
    datumWKT += ",TOWGS84[" + Te2String(shiftX, 4) + "," +
                Te2String(shiftY, 4) + "," + Te2String(shiftZ, 4) +
                ",0.0,0.0,0.0,0.0]";
