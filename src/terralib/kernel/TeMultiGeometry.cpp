...
void TeMultiGeometry::setGeometry(const TeLineSet &result) { lines_ = result; }

void TeMultiGeometry::setGeometry(const TePointSet &result) {
  points_ = result;
}

void TeMultiGeometry::setGeometry(const TeCellSet &result) { cells_ = result; }

void TeMultiGeometry::setGeometry(const TeTextSet &result) { texts_ = result; }
