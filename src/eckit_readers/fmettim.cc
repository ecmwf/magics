...
void TMetTime ::NextMetTime(void) { NextMetTime(GetTimeStep()); }
//__________________________________________________________________
...
void TMetTime ::PreviousMetTime(void) { PreviousMetTime(GetTimeStep()); }
//__________________________________________________________________
...
void TMetTime ::NearestMetTime(void) { NearestMetTime(GetTimeStep()); }
//__________________________________________________________________
...
short TMetTime ::GetTimeStep(void) const { return fTimeStepInMinutes; }
//__________________________________________________________________
