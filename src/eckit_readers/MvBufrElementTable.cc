...
bool codesCheck(const char *call, const char *file, int line, int e,
                const char *msg) {
  if (e) {
...
MvBufrElementTable *MvBufrElementTable::find(MvBufrEdition *edition) {
  for (std::vector<MvBufrElementTable *>::const_iterator it = tables_.begin();
       it != tables_.end(); ++it) {
...
static map_bufr_table create_map() {
  ...
  map[10039] =
      "departureOfReferenceLevelSummerMaximumLoadLineFromActualSeaLevel";
  ...
  map[15052] =
      "log10OfNumberDensityOfAerosolParticlesWithDiameterGreaterThan5Nm";
  map[15053] =
      "log10OfNumberDensityOfAerosolParticlesWithDiameterGreaterThan14Nm";
  map[15054] =
      "log10OfNumberDensityOfAerosolParticlesWithDiameterBetween0p25And2p5";
  ...
  map[19009] =
      "effectiveRadiusWithRespectToWindSpeedsAboveThresholdLargeStorms";
  ...
  map[19107] =
      "timeIntervalOverWhichMovementOfTropicalCycloneHasBeenCalculated";
  ...
  map[20054] = "trueDirectionFromWhichAPhenomenonOrCloudsAreMovingOrInWhichThey"
               "AreObserved";
  ...
  map[24013] =
      "gammaDoseInAirAlongMainTransportPathDefinedLocationAndTimePeriod";
  ...
  map[33087] =
      "extentOfSatelliteWithinSouthAtlanticAnomalyBasedOnClimatologicalData";
  map[33088] = "ozoneTotalColumnQualityFlag";
  map[33089] = "noiseEquivalentDeltaTemperatureNedtQualityIndicatorsForWarmTarg"
               "etCalibration";
