...
{
	methods_["date"] = &GeoJSon::date;
	methods_["time"] = &GeoJSon::time;
	methods_["eps_height"] = &GeoJSon::epsz;
	methods_["height"] = &GeoJSon::height;
	methods_["deterministic_height"] = &GeoJSon::detz;
	methods_["tracker"] = &GeoJSon::ignore;
	methods_["missing"] = &GeoJSon::missing;
	methods_["location"] = &GeoJSon::location;
	methods_["station_name"] = &GeoJSon::station_name;
	methods_["requested_location"] = &GeoJSon::station;
	methods_["land_sea_mask"] = &GeoJSon::mask;
	methods_["metadata"] = &GeoJSon::metadata;
	methods_["points_along_meridian"] = &GeoJSon::points_along_meridian;
	
	methods_["x_values"] = &GeoJSon::x_values;
	methods_["x_date_values"] = &GeoJSon::x_date_values;
	methods_["y_values"] = &GeoJSon::y_values;
	methods_["y_date_values"] = &GeoJSon::y_date_values;
	methods_["values"] = &GeoJSon::values;

	decoders_["eps"] = &GeoJSon::eps;
	decoders_["profile"] = &GeoJSon::profile;
	decoders_["efi"] = &GeoJSon::efi;
	decoders_["cdf"] = &GeoJSon::cdf;
	decoders_["basic"] = &GeoJSon::basic;
	decoders_["data"] = &GeoJSon::data;
	
	transformationHandlers_["eps"] = &GeoJSon::eps;
	transformationHandlers_["cdf"] = &GeoJSon::cdf;
	transformationHandlers_["efi"] = &GeoJSon::efi;
	transformationHandlers_["profile"] = &GeoJSon::profile;

    heightCorrections_["forecast"] = &GeoJSon::correctDetz;
    
    metaMethods_["temperature_correction"] = &GeoJSon::temperature_correction;
    metaMethods_["temperature_adjustment"] = &GeoJSon::temperature_adjustment;
    metaMethods_["eps_resolution"] = &GeoJSon::eps_resolution;
    metaMethods_["deterministic_resolution"] = &GeoJSon::deterministic_resolution;
    metaMethods_["station_name"] = &GeoJSon::station_name;
    metaMethods_["height"] = &GeoJSon::height;
...
void GeoJSon::visit(Transformation& transformation)
{
...
void GeoJSon::profile(Transformation& transformation)
{
...
void GeoJSon::eps(Transformation& transformation)
{
	if ( keyword_ != "clim" ) {
...
void GeoJSon::cdf(Transformation& transformation)
{
	transformation.setDataMinMaxX(minx_, maxx_);
	transformation.setDataMinMaxY(0, 100);

}
void GeoJSon::efi(Transformation& transformation)
{
...
void GeoJSon::eps()
{
	...
	shift_ = 12;
	methods_[param_] = &GeoJSon::parameter;
	methods_[keyword_] = &GeoJSon::dig;
...
void GeoJSon::customisedPoints(const Transformation& transformation, const std::set<string>& needs, CustomisedPointsList& out)
{
...
void GeoJSon::customisedPoints(const std::set<string>&, CustomisedPointsList& out)
{
	MagLog::dev() << "GeoJSon::customisedPoints" << std::endl;
...
void GeoJSon::metadata(const json_spirit::Value& value )
{
	metadata_ = value;
	dig(value);
}

void GeoJSon::station(const json_spirit::Value& value )
{
...
void GeoJSon::location(const json_spirit::Value& value )
{
...
void GeoJSon::station_name(const json_spirit::Value& value )
{
    string station;
...
void GeoJSon::epsz(const json_spirit::Value& value)
{
	assert( value.type() == real_type);
	epsz_ = value.get_value< double>();
	MagLog::dev() << "found -> epsz= " <<  epsz_ << endl;
}
void GeoJSon::height(const json_spirit::Value& value)
{
...
void GeoJSon::time(const json_spirit::Value& value)
{
...
void GeoJSon::parameter(const json_spirit::Value& value)
{
	assert( value.type() == obj_type );
...
void GeoJSon::cdf() 
{
	if ( !clim_.empty() ) return;
	 ...
	 file_ = path_;
	 methods_["clim"] =  &GeoJSon::clim;
	 methods_["eps"] = &GeoJSon::eps;
	 methods_["efi"] = &GeoJSon::efi;
	 methods_[param_] =  &GeoJSon::parameter;
	 scaling_factor_ = param_scaling_factor_;
	 	offset_factor_ = param_offset_factor_;
...
void GeoJSon::efi()
{
	if ( !efi_.empty() ) return;
	 ...
	 file_ = path_;
	 methods_["clim"] =  &GeoJSon::ignore;
	 methods_["eps"] = &GeoJSon::ignore;
	 methods_["efi"] = &GeoJSon::efi;
	 methods_[param_] =  &GeoJSon::parameter;
...
void GeoJSon::clim(const json_spirit::Value& value)
{
...
void GeoJSon::efi(const json_spirit::Value& value)
{
...
void GeoJSon::eps(const json_spirit::Value& value)
{
...
double GeoJSon::correctDetz(double value)
{
...
double GeoJSon::correctEpsz(double value)
{
    if (correction_ && height_ != -9999) {
...
void GeoJSon::visit(MetaDataVisitor& visitor)
{
...
Value GeoJSon::temperature_correction()
{
	bool correction = (correction_ && height_ != -9999 );
	Value value(correction);
	return value;
}
Value  GeoJSon::temperature_adjustment()
{
	Value value;
	if (correction_ && height_ != -9999) {
		Object correction;;
...
void GeoJSon::points_along_meridian(const json_spirit::Value& value)
{
...
void GeoJSon::x_values(const json_spirit::Value& value)
{
...
void GeoJSon::values(const json_spirit::Value& value)
{
	assert (value.type() == array_type);
	Array values = value.get_value<Array>();
	bool newpoint = points_.empty();
...
void GeoJSon::y_values(const json_spirit::Value& value)
{
	assert (value.type() == array_type);
	Array values = value.get_value<Array>();
	bool newpoint = points_.empty();
...
void GeoJSon::x_date_values(const json_spirit::Value& value)
{
...
void GeoJSon::y_date_values(const json_spirit::Value& value)
{
	assert (value.type() == array_type);
	Array values = value.get_value<Array>();
	ydate_ = true;
...
json_spirit::Value GeoJSon::eps_resolution()
{
	Value value(tostring(points_along_meridian_));
	return value;
}

json_spirit::Value GeoJSon::deterministic_resolution()
{
	Value value(tostring(points_along_meridian_));
	return value;
}
json_spirit::Value GeoJSon::station_name()
{
	Value value(station_name_);
	return value;
}
json_spirit::Value GeoJSon::height()
{
...
void GeoJSon::visit(TextVisitor& text)
{
	if ( !title_ )
		return;
