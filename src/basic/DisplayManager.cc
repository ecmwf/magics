...
void DisplayManager::operator()(BasicSceneObject &object,
                                BasicGraphicsObjectContainer &list) {
...
void DisplayManager::topHorizontal(BasicSceneObject &object,
                                   BasicGraphicsObjectContainer &list) {
  object.resize();
  if (x_ == -1 && y_ == -1) {
...
void DisplayManager::addBlock(BasicSceneObject &object,
                              BasicGraphicsObjectContainer &list) {
  object.resize();
  if (x_ == -1 && y_ == -1) {
    // Calculate the position
...
void DisplayManager::addInline(BasicSceneObject &object,
                               BasicGraphicsObjectContainer &list) {
  object.resize();
  if (x_ == -1 && y_ == -1) {
    // Calculate the position
...
void DisplayManager::bottomVertical(BasicSceneObject &object,
                                    BasicGraphicsObjectContainer &list) {
  object.resize();
  if (x_ == -1 && y_ == -1) {
    // Calculate the position
...
void DisplayManager::bottomHorizontal(BasicSceneObject &,
                                      BasicGraphicsObjectContainer &) {}

void DisplayManager::nothing(BasicSceneObject &object,
                             BasicGraphicsObjectContainer &list) {
  if (object.needNewPage())
    object.askNewPage(list);
}

void DisplayManager::topVertical(BasicSceneObject &object,
                                 BasicGraphicsObjectContainer &list) {
  object.resize();
  if (x_ == -1 && y_ == -1) {
    // Calculate the position
...
void DisplayManager::style(const string &style, const string &start,
  ...
  else if (magCompare(direction, "vertical"))
