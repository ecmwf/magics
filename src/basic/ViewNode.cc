...
ViewNode::ViewNode()
    : viewTransformation_(0), animation_("basic"), vaxis_(2.), haxis_(1.),
      rules_(0), legend_(0), needLegend_(false),
...
static SimpleObjectMaker<NoOverlayAnimationRules, AnimationRules>
    never("never");
static SimpleObjectMaker<LevelAnimationRules, AnimationRules>
    by_level("by_level");
