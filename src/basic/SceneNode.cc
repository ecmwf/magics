...
void FortranSceneNode::getReady() {
  ...
  layout_->frame(false, FortranSceneNodeAttributes::frame_, *frame_colour_,
                 frame_line_style_, frame_thickness_, Colour("white"));
...
void XmlSceneNode::getReady() {
  ...
  layout_->frame(false, border_, *border_colour_, border_style_,
