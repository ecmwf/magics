...
void LeftAxisVisitor::tick(double &x1, double &x2, bool) {
  double length =
      ((current_->xmax_ - current_->xmin_) / current_->absoluteWidth()) * 0.2;
  x2 = current_->xmax_;
...
void LeftAxisVisitor::minortick(double &x1, double &x2, bool) {
  double length =
      ((current_->xmax_ - current_->xmin_) / current_->absoluteWidth()) * 0.1;
  x2 = current_->xmax_;
  x1 = current_->xmax_ - length;
}

double LeftAxisVisitor::offsetTickLabel(double height, double from) {
  double h = ((current_->xmax_ - current_->xmin_) / current_->absoluteWidth()) *
             (height * 0.6);

  return from - h;
}

double LeftAxisVisitor::angleTickLabel() { return 0; }

double LeftAxisVisitor::angleTitle() { return 3 * 3.14 / 2; }

double LeftAxisVisitor::offsetTitle(int) { return current_->xmin_; }
double LeftAxisVisitor::angleTip() { return 3 * 3.14 / 2; }

double LeftAxisVisitor::offsetTip() { return current_->xmin_; }
...
double RightAxisVisitor::angleTickLabel() { return 0; }

double RightAxisVisitor::angleTitle() { return 3.14 / 2; }

double RightAxisVisitor::offsetTitle(int) { return current_->xmax_; }
double RightAxisVisitor::angleTip() { return 3.14 / 2; }

double RightAxisVisitor::offsetTip() { return current_->xmax_; }

void TopAxisVisitor::tick(double &y1, double &y2, bool out) {
  double length =
      ((current_->ymax_ - current_->ymin_) / current_->absoluteHeight()) * 0.15;
  y1 = current_->ymin_;
...
void TopAxisVisitor::minortick(double &y1, double &y2, bool out) {
  double length =
      ((current_->ymax_ - current_->ymin_) / current_->absoluteHeight()) * 0.1;
  y2 = current_->ymin_;
...
double TopAxisVisitor::offsetTickLabel(double height, double from) {
  double h =
      ((current_->ymax_ - current_->ymin_) / current_->absoluteHeight()) *
      height;
  return from + h;
}

double TopAxisVisitor::angleTickLabel() { return 0; }

double TopAxisVisitor::angleTitle() { return 0; }

double TopAxisVisitor::offsetTitle(int) { return current_->ymax_; }

double TopAxisVisitor::angleTip() { return 0; }

double TopAxisVisitor::offsetTip() { return current_->ymax_; }
...
double BottomAxisVisitor::angleTickLabel() { return 0; }

double BottomAxisVisitor::angleTitle() { return 0; }

double BottomAxisVisitor::offsetTitle(int) { return current_->ymin_; }

double BottomAxisVisitor::angleTip() { return 0; }

double BottomAxisVisitor::offsetTip() { return current_->ymin_; }
...
Justification
TopAxisVisitor::justificationTickLabel(const string &orientation) {
  // horizontal == parallel
  return (magCompare(orientation, "vertical")) ? MLEFT : MCENTRE;
}

Justification
BottomAxisVisitor::justificationTickLabel(const string &orientation) {
  // horizontal == parallel
  return (magCompare(orientation, "vertical")) ? MRIGHT : MCENTRE;
}

Justification
LeftAxisVisitor::justificationTickLabel(const string &orientation) {
  // vertical == parallel
  return (magCompare(orientation, "horizontal")) ? MRIGHT : MCENTRE;
}
Justification
RightAxisVisitor::justificationTickLabel(const string &orientation) {
  // vertical == parallel
  return (magCompare(orientation, "horizontal")) ? MLEFT : MCENTRE;
}
Justification
VerticalAxisVisitor::justificationTickLabel(const string &orientation) {
  return MCENTRE;
}
