...
BasicSceneNode *MagMLLayoutManager::block(BasicSceneNode *parent,
                                          BasicPositionalObject *node) {
...
BasicSceneNode *
MagMLLayoutManager::inline_display(BasicSceneNode *parent,
                                   BasicPositionalObject *node) {
  Layout &layout = node->layout();
  // first fits in width!
...
BasicSceneNode *MagMLLayoutManager::absolute(BasicSceneNode *parent,
...
BasicSceneNode *MagMLLayoutManager::operator()(BasicSceneNode *parent,
                                               BasicPositionalObject *node) {
  Layout &layout = node->layout();
...
BasicSceneNode *BottomVerticalLayoutManager::
operator()(BasicSceneNode *parent, BasicPositionalObject *node) {
  Layout &layout = node->layout();
  // first fits in width!
...
BasicSceneNode *BottomHorizontalLayoutManager::
operator()(BasicSceneNode *parent, BasicPositionalObject *node) {
  Layout &layout = node->layout();
  // first fits in width!
...
BasicSceneNode *LayoutManager::operator()(BasicSceneNode *parent,
                                          BasicPositionalObject *node) {
  if (newpage_) {
    newpage_ = false;
    return parent->newNode(node);
...
BasicSceneNode *TopHorizontalLayoutManager::
operator()(BasicSceneNode *parent, BasicPositionalObject *node) {
  Layout &layout = node->layout();
  // first fits in width!
...
LayoutManager *LayoutManager::manager(const string &type, const string &start,
...
BasicSceneNode *TopVerticalLayoutManager::
operator()(BasicSceneNode *parent, BasicPositionalObject *node) {
  Layout &layout = node->layout();
  // first fits in width!
  if (x_ + layout.width() <= 100) {
