...
asia = mmap({ "subpage_upper_right_longitude": 175.,
...
cloud_cover_contour = mcont({
        ...
        'contour_max_level': 63.5,
        'contour_reference_level': -0.5,
        'contour_interval': 1.,
        'contour_hilo': 'off',
        'contour_shade': 'on',
...
#To turn the legend off!
legend = mlegend({"legend":"off"}) 
#To the plot
plot(files, asia, cloud_cover, cloud_cover_contour, coast, title, legend)
