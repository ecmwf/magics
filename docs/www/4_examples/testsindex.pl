...
my $dest="html/test/fortran/index.html";
...
sub content {
    ...
    $default = "<table background=\"/assets/shim.gif\" bgcolor=\"#FFF1B3\" border=\"0\""
               ...
               . "<tbody>" 
               . "  <tr>" 
                . "    <td  class=\"menuheading\">Magics++ Programming Examples</a> </td>"
               . "  </tr>" 
               . "  <tr>" 
                . "    <td   bgcolor=\"#ffffff\">
    <P><P>
	...
	<P>
	<B>Note that the examples here are for information purposes only.
    MAGICS++ is currently very much in development and its behaviour is
    subject to change.</B>
						</td>"
               . "  <tr>" 
               ...
               . "  </tr>" 
               . "  <tr>" 
                . "    <td  class=\"menuheading\"> Test Programs </a> </td>"
               . "  </tr>" 
               . "  </tr>";
