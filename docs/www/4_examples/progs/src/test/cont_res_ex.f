...
C     Define the contour     
      ...
      CALL PSETR ('CONTOUR_AKIMA_X_RESOLUTION',  1.5)
      CALL PSETR ('CONTOUR_AKIMA_Y_RESOLUTION',  1.5)
...
C     New page, this time using a different contouring resolution
      ...
      CALL PSETR ('CONTOUR_AKIMA_X_RESOLUTION',  1.2)
      CALL PSETR ('CONTOUR_AKIMA_Y_RESOLUTION',  1.2)
      CALL PSETC ('TEXT_LINE_1', 
...
C     New page, this time using a different contouring resolution
      ...
      CALL PNEW  ('SUPER_PAGE')
      CALL PSETR ('CONTOUR_AKIMA_X_RESOLUTION',  1.0)
      CALL PSETR ('CONTOUR_AKIMA_Y_RESOLUTION',  1.0)
      CALL PSETC ('TEXT_LINE_1', 
...
C     New page, this time using a different contouring resolution
      ...
      CALL PNEW  ('SUPER_PAGE')
      CALL PSETR ('CONTOUR_AKIMA_X_RESOLUTION',  0.8)
      CALL PSETR ('CONTOUR_AKIMA_Y_RESOLUTION',  0.8)
      CALL PSETC ('TEXT_LINE_1', 
...
C     New page, this time using a different contouring resolution
      ...
      CALL PNEW  ('SUPER_PAGE')
      CALL PSETR ('CONTOUR_AKIMA_X_RESOLUTION',  0.5)
      CALL PSETR ('CONTOUR_AKIMA_Y_RESOLUTION',  0.5)
      CALL PSETC ('TEXT_LINE_1', 
