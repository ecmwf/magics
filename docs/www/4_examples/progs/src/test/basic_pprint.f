...
C     This program uses the PPRINT action routine to inform
C     the user of the actual page dimensions used.
C     This can be useful when MAGICS has automatically resized
C     the page.
...
C     Open MAGICS and set the output device
      ...
      CALL POPEN
      CALL PARSE_COMMAND_LINE ('basic_pprint')
...
C     Print the page size information
