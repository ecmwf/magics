...
ccccccc        WRITE(FILPLOT,'("scatbin_MEMO_",i4)') YEAR
        CALL POPEN
        CALL PARSE_COMMAND_LINE ('graph_venice_02')
...
C       READ INITIAL AND FINAL DATES - standard input
C       will be read from a text file

        OPEN(5, FILE='data/graph_venice_02_stdin.txt')
...
c      NSTAZ = 1
      ...
      OPEN(11, FILE='data/TOWER.ope_2010')
      OPEN(12, FILE='data/POMAE.ope_2010')
      OPEN(13, FILE='data/ANCON.ope_2010')
      OPEN(14, FILE='data/PESCA.ope_2010')
      OPEN(15, FILE='data/MONOP.ope_2010')
