...
*
      ...
      CALL PSETC ('PS_FILE_NAME','text07.ps')
      CALL PSETC ('PAGE_ID_LINE_USER_TEXT','Tests/Text07')
...
*     --------------------------------------------
      ...
      CALL PSETI('TEXT_REDUCTION_LEVEL',0)
