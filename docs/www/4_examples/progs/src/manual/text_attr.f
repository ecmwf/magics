...
C     This program demonstrates text plotting attributes in Magics++.
...
C     Open MAGICS and set the output device
      ...
      CALL PSETC ('PS_FILE_NAME', 'text_attr.ps')
...
C     Text box 9
      ...
      CALL PSETC ('TEXT_LINE_3', 'Font: Times-Roman')
      CALL PSETC ('TEXT_LINE_4', 'Colour: @TEXT_COLOUR@')
      CALL PSETC ('TEXT_FONT',   'Times-Roman')
      CALL PSETR ('TEXT_REFERENCE_CHARACTER_HEIGHT', 0.3)
      CALL PSETI ('TEXT_BORDER_THICKNESS', 1)
      CALL PSETC ('TEXT_BORDER_COLOUR', 'PURPLE')
      CALL PSETC ('TEXT_JUSTIFICATION', 'LEFT')
...
C     ----- Start a new superpage ------
      ...
      DO I = 1, NFONTS
        CALL PSETR ('TEXT_BOX_Y_POSITION',  
     x               SUPER_H - (I * BOX_HEIGHT * 1.05))
